...
return [
    ...
    'View' => 'Посмотреть',
    'Yes' => 'Да',
    'You are not allowed to perform this action.' => 'Вы не можете выполнять это действие.',
    ...
    '-- Select Department --' => '-- Выбрать Oтдел --',
    '<-- Back' => '<-- Назад',
    'Are you sure you want to delete this item?' => 'Вы уверены, что хотите удалить этот элемент',
    'Cancel' => 'Отмена',
    'Create Department' => 'Создать отдел',
    'Create Member' => 'Создать пользователя',
    'Create Staff Member' => 'Создать сотрудника',
    'Date of Hire' => 'Дата проката',
    'Delete' => 'Удалить',
    'Delete Departments' => 'Удалить отделы',
    'Delete Members' => 'Удалить участников',
    'Department' => 'Oтдел',
    'Departments' => 'Bедомства',
    'Home' => 'Главная',
    'If you delete this item must be delete the staff member associated to. Do you want to delete this item?' => 'Если вы удалите этот элемент, необходимо удалить связанного с ним сотрудника. Удалить этот элемент?',
    'List of Departments' => 'Список отделений',
    ...
    'Update Department: ' => 'Отдел обновления:',
    'Update Staff Member' => 'Обновить сотрудника',
    'Update Staff Member: ' => 'Обновить сотрудника:',
    'My Company' => 'Моя компания',
    'Login' => 'Авторизоваться',
    'Logout' => 'Выйти',
    'Invalid {attribute} (format is MM/DD/YYYY)' => 'Инвалид {attribute}, (Формат MM/DD/YYYY)',
    'Are you sure you want to delete these items?' => 'Вы действительно хотите удалить эти элементы?',
    'View' => 'Посмотреть',
    'Edit' => 'Pедактировать',
    'View Department' => 'Отдел просмотра',
    'Login to your account' => 'Войдите в свой аккаунт',
    'Enter any username and password.'=>'Введите любое имя пользователя и пароль.',
    'Username' => 'имя пользователя',
    'Password' => 'Пароль',
    'OK' => 'одобрять',
    'View Member' => 'Просмотр',
